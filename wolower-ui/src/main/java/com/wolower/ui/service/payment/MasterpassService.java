...
public class MasterpassService {
	...
	void savePrecheckout(User user, PreCheckoutData precheckoutData, Masterpass masterpass) {
	...
	void saveExpressCheckout(User user, PaymentData paymentData, Masterpass masterpass) {
